...
import { deleteCourse, deleteRegistration, getDetailedCourse } from '../../Store/Features/Courses/courses.actions';
import { selectCourseDetailedSuccess, selectCoursesSuccess, selectRegistrationsSuccess } from '../../Store/Features/Courses/courses.selectors';
...
export class CoursesListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //Arreglo de inscripciones desde store

    // this.subscriptions.add(
    //   this.store.select(selectRegistrationsSuccess).subscribe(
    //     (val)=>{
    //       if (val.registrations.length>0){
    //         this.registration=val.registrations;
    //       }
    //       console.log(val);
    //     }
    //   )
